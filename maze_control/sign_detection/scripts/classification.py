...
def classify(img):
    ...
    template=[]
    template.append(cv2.imread("../templates/0.png",0))
    template.append(cv2.imread("../templates/1.png",0))
    template.append(cv2.imread("../templates/2.png",0))
    template.append(cv2.imread("../templates/3.png",0))
